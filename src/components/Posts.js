        ...
        {Object.keys(posts).map((postsKey, idx) => (
          <div className="hover:shadow-sm rounded-2xl shadow-lg md:p-8 p-2 bg-white">
            ...
            <div className="flex gap-4 mt-5">
              <button className="flex items-center gap-1 h-10 border border-orange-base px-3  rounded-full hover:bg-orange-base hover:text-white transition-colors focus:bg-orange-secondary focus:outline-none focus-visible:border-orange-secondary">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
                ...
                <span>{posts[postsKey].likes.length}</span>
              </button>
              <button className="flex items-center gap-1 h-10  border border-orange-base px-3  rounded-full hover:bg-orange-base hover:text-white transition-colors focus:bg-orange-secondary focus:outline-none focus-visible:border-orange-secondary">
                <svg
                  stroke="currentColor"
